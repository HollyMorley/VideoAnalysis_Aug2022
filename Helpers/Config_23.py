...
short_names = {
        ...
        'signed_angle|ToeKnuckle_ipsi_side_zref_swing_mean': 'Ipsi Toe-Knuckle angle - pitch (mean)',
        'signed_angle|ToeKnuckle_ipsi_side_zref_swing_peak': 'Ipsi Toe-Knuckle angle - pitch (peak)',
        'signed_angle|ToeKnuckle_contra_side_zref_swing_mean': 'Contra Toe-Knuckle angle - pitch (mean)',
        'signed_angle|ToeKnuckle_contra_side_zref_swing_peak': 'Contra Toe-Knuckle angle - pitch (peak)',
        'signed_angle|ToeAnkle_ipsi_side_zref_swing_mean': 'Ipsi Toe-Ankle angle - pitch (mean)',
        'signed_angle|ToeAnkle_ipsi_side_zref_swing_peak': 'Ipsi Toe-Ankle angle - pitch (peak)',
        'signed_angle|ToeAnkle_contra_side_zref_swing_mean': 'Contra Toe-Ankle angle - pitch (mean)',
        'signed_angle|ToeAnkle_contra_side_zref_swing_peak': 'Contra Toe-Ankle angle - pitch (peak)',
        'signed_angle|Back1Back12_side_zref_swing_mean': 'Back angle - pitch (mean)',
        'signed_angle|Back1Back12_side_zref_swing_peak': 'Back angle - pitch (peak)',
        'signed_angle|Tail1Tail12_side_zref_swing_mean': 'Tail angle - pitch (mean)',
        'signed_angle|Tail1Tail12_side_zref_swing_peak': 'Tail angle - pitch (peak)',
        'signed_angle|NoseBack1_side_zref_swing_mean': 'Head angle - pitch (mean)',
        'signed_angle|NoseBack1_side_zref_swing_peak': 'Head angle - pitch (peak)',
        'signed_angle|Back1Back12_overhead_xref_swing_mean': 'Back angle - yaw (mean)',
        'signed_angle|Back1Back12_overhead_xref_swing_peak': 'Back angle - yaw (peak)',
        'signed_angle|Tail1Tail12_overhead_xref_swing_mean': 'Tail angle - yaw (mean)',
        'signed_angle|Tail1Tail12_overhead_xref_swing_peak': 'Tail angle - yaw (peak)',
        'signed_angle|NoseBack1_overhead_xref_swing_mean': 'Head angle - yaw (mean)',
        'signed_angle|NoseBack1_overhead_xref_swing_peak': 'Head angle - yaw (peak)',
}
