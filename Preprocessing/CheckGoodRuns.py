...
class CheckRuns:
    def __init__(self, file, mouseID, date, exp=None, speed=None, repeat_extend=None, exp_wash=None, day=None,
...
class GetAllFiles:
    ...
    def GetFiles(self):
        files = utils.Utils().GetListofRunFiles(self.directory)  # gets dictionary of side, front and overhead 3D files
